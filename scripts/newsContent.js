...
const newsData = {
    // News Item 1
    '1': {
        title: 'Cinetour "Lật Mặt 8: Vòng tay nắng" khuấy động Trung tâm Chiếu phim Quốc gia',
        date: '29/04/2025',
        ...
        images: [
            {
                ...
                caption: 'Toàn cảnh buổi giao lưu với khán giả tại Trung tâm Chiếu phim Quốc gia'
            },
            {
        ...
        paragraphs: [
            ...
            'Sự kiện Cinetour "Lật mặt 8: Vòng tay nắng" tại Trung tâm Chiếu phim Quốc gia đã khép lại thành công, để lại nhiều ấn tượng đẹp trong lòng khán giả yêu điện ảnh Việt Nam.'
        ],
        relatedNews: [
            { id: 2, title: 'Cinetour "Thám Tử Kiên: Kỳ Án Không Đầu" - Giao lưu bùng nổ tại Trung tâm Chiếu phim Quốc gia' },
            { id: 3, title: 'THẾ QUYỀN LỰC CHO GEN Z ĐẨY RỒI!!!' },
            { id: 6, title: 'Buổi Cinetour của đoàn làm phim "Địa đạo: Một trời trong bóng tối" tại Trung tâm Chiếu phim Quốc gia' }
        ]
    },

    // News Item 2
    '2': {
        title: 'Cinetour "Thám Tử Kiên: Kỳ Án Không Đầu" - Giao lưu bùng nổ tại Trung tâm Chiếu phim Quốc gia',
        date: '29/04/2025',
        intro: 'Đoàn làm phim "Thám Tử Kiên: Kỳ Án Không Đầu" đã có buổi gặp gỡ khán giả tại Trung tâm Chiếu phim Quốc gia. Sự kiện thu hút hàng trăm người hâm mộ, với sự tham gia của đạo diễn Phạm Gia An cùng dàn diễn viên chính của tác phẩm kinh dị được mong đợi nhất năm nay.',
        images: [
            {
                src: 'assets/images/new/thamtukien1.jpg',
                caption: 'Đoàn làm phim giao lưu với khán giả tại Trung tâm Chiếu phim Quốc gia'
            },
            {
        ...
        relatedNews: [
            { id: 1, title: 'Cinetour "Lật Mặt 8: Vòng tay nắng" khuấy động Trung tâm Chiếu phim Quốc gia' },
            { id: 8, title: 'Sự kiện ra mắt phim Địa Đạo - Một Trời Trong Bóng Tối tại Trung tâm Chiếu phim Quốc gia' },
    ...
    '3': {
        ...
        date: '24/04/2025',
        intro: 'Sự kiện đặc biệt "Thế Quyền Lực Cho Gen Z" đã diễn ra tại Trung tâm Chiếu phim Quốc gia với sự tham gia của hàng trăm bạn trẻ thuộc thế hệ Gen Z. Chương trình không chỉ mang đến những bộ phim đặc sắc mà còn tạo ra diễn đàn thảo luận sôi nổi về vai trò của điện ảnh trong việc định hình tư duy của giới trẻ.',
        images: [
            {
                src: 'assets/images/new/thegenz1.jpg',
                caption: 'Các bạn trẻ Gen Z tham gia sự kiện tại Trung tâm Chiếu phim Quốc gia'
            },
            {
        ...
        relatedNews: [
            { id: 1, title: 'Cinetour "Lật Mặt 8: Vòng tay nắng" khuấy động Trung tâm Chiếu phim Quốc gia' },
            { id: 7, title: 'Danh sách cộng tác viên trúng tuyển tại Trung tâm Chiếu phim Quốc gia tháng 4/2025' },
    ...
    '4': {
        ...
        date: '24/04/2025',
        intro: 'Kỷ niệm 50 năm Ngày Giải phóng miền Nam, thống nhất đất nước (30/4/1975 - 30/4/2025) và các ngày lễ lớn 1/5, 7/5/2025, Trung tâm Chiếu phim Quốc gia tổ chức đợt phim đặc biệt với hàng loạt tác phẩm điện ảnh kinh điển và hiện đại về lịch sử đấu tranh giải phóng dân tộc.',
        images: [
            {
            ...
            },
            {
                ...
                caption: 'Lễ khai mạc đợt phim kỷ niệm tại Trung tâm Chiếu phim Quốc gia'
            }
        ],
        paragraphs: [
            ...
            'Bên cạnh việc chiếu phim, Trung tâm Chiếu phim Quốc gia còn tổ chức nhiều hoạt động phụ trợ như triển lãm ảnh "50 năm nhìn lại", tọa đàm "Điện ảnh và lịch sử dân tộc" cùng chương trình giao lưu với các đạo diễn, diễn viên gạo cội của nền điện ảnh cách mạng Việt Nam.',
            'Đại diện Trung tâm Chiếu phim Quốc gia cho biết: "Đợt phim này không chỉ là dịp để ôn lại truyền thống lịch sử hào hùng của dân tộc mà còn là cơ hội để các thế hệ hôm nay, đặc biệt là giới trẻ, hiểu hơn về giá trị của hòa bình, độc lập và tự do mà các thế hệ cha anh đã đổi bằng xương máu để giành được."',
    ...
    '5': {
        ...
        date: '17/04/2025',
        intro: 'Trung tâm Chiếu phim Quốc gia (NCC) chính thức ra mắt chương trình "Suất chiếu đặc biệt sáng thứ 7" - một sáng kiến nhằm mang đến trải nghiệm xem phim độc đáo vào buổi sáng cuối tuần, hướng tới đối tượng gia đình và các bạn nhỏ.',
        images: [
            {
    ...
    '6': {
        title: 'Buổi Cinetour của đoàn làm phim "Địa đạo: Một trời trong bóng tối" tại Trung tâm Chiếu phim Quốc gia',
        date: '07/04/2025',
        intro: 'Buổi Cinetour của đoàn làm phim "Địa đạo: Một trời trong bóng tối" tại Trung tâm Chiếu phim Quốc gia (NCC) vào tối ngày 3/4/2025 đã để lại ấn tượng sâu sắc trong lòng khán giả.',
        images: [
            {
                src: 'assets/images/new/diadao1.jpg',
                caption: 'Đoàn làm phim chụp ảnh với khán giả tại Trung tâm Chiếu phim Quốc gia'
            },
            {
    ...
    '7': {
        title: 'Danh sách cộng tác viên trúng tuyển tại Trung tâm Chiếu phim Quốc gia tháng 4/2025',
        date: '02/04/2025',
        intro: 'Trung tâm Chiếu phim Quốc gia xin thông báo danh sách cộng tác viên trúng tuyển tại Trung tâm Chiếu phim Quốc gia tháng 4/2025. Xin chúc mừng tất cả các bạn đã trúng tuyển cộng tác viên tại TTCPQG!',
        images: [
            {
    ...
    '8': {
        title: 'Sự kiện ra mắt phim Địa Đạo - Một Trời Trong Bóng Tối tại Trung tâm Chiếu phim Quốc gia.',
        date: '02/04/2025',
        intro: 'Tối qua, sự kiện ra mắt phim Địa Đạo - Một Trời Trong Bóng Tối đã chính thức diễn ra tại Trung tâm Chiếu phim Quốc gia, thu hút sự chú ý mạnh mẽ từ đông đảo khách mời đến từ các cơ quan, ban ngành, nghệ sĩ, cùng cộng đồng yêu điện ảnh Việt Nam. ',
        images: [
            {
    ...
    '9': {
        title: 'Liên hoan phim ngắn cuối tuần tại Trung tâm Chiếu phim Quốc gia',
        date: '01/04/2025',
        intro: 'Trung tâm Chiếu phim Quốc gia khởi động chuỗi sự kiện "Liên hoan phim ngắn cuối tuần" nhằm tạo sân chơi cho các nhà làm phim trẻ và giới thiệu những tác phẩm điện ảnh ngắn xuất sắc đến công chúng.',
        images: [
            {
                src: 'assets/images/new/ramat2.jpg',
        ...
        paragraphs: [
            'Liên hoan phim ngắn cuối tuần sẽ diễn ra định kỳ vào các ngày cuối tuần tại Trung tâm Chiếu phim Quốc gia. Mỗi tuần sẽ có một chủ đề khác nhau, tạo nên sự đa dạng và phong phú cho sự kiện.',
    ...
    '10': {
        title: 'Triển lãm "50 năm điện ảnh Việt Nam" tại Trung tâm Chiếu phim Quốc gia',
        date: '29/03/2025',
        intro: 'Triển lãm "50 năm điện ảnh Việt Nam" được tổ chức tại Trung tâm Chiếu phim Quốc gia, tái hiện chặng đường phát triển của nền điện ảnh nước nhà từ 1975 đến 2025 với hàng trăm hiện vật, tư liệu quý giá.',
        images: [
            {
                src: 'assets/images/new/latmat3.jpg',
                caption: 'Không gian triển lãm tại Trung tâm Chiếu phim Quốc gia'
            }
        ],
        paragraphs: [
    ...
    '11': {
        title: 'Workshop "Nghệ thuật dựng phim" tại Trung tâm Chiếu phim Quốc gia',
        date: '25/03/2025',
        intro: 'Workshop "Nghệ thuật dựng phim" do Trung tâm Chiếu phim Quốc gia phối hợp với Hiệp hội Điện ảnh Việt Nam tổ chức đã thu hút đông đảo sinh viên điện ảnh và những người đam mê làm phim tham gia.',
        images: [
            {
                src: 'assets/images/new/thamtukien3.jpg',
                caption: 'Không khí workshop tại Trung tâm Chiếu phim Quốc gia'
            }
        ],
        paragraphs: [
        ...
        relatedNews: [
            { id: 3, title: 'THẾ QUYỀN LỰC CHO GEN Z ĐẨY RỒI!!!' },
            { id: 9, title: 'Liên hoan phim ngắn cuối tuần tại Trung tâm Chiếu phim Quốc gia' },
            { id: 5, title: 'SUẤT CHIẾU ĐẶC BIỆT SÁNG THỨ 7 TẠI NCC' }
        ]
    },

    '12': {
        title: 'Lễ trao giải cuộc thi "Kịch bản phim ngắn Việt Nam 2025" tại Trung tâm Chiếu phim Quốc gia',
        date: '20/03/2025',
        intro: 'Lễ trao giải cuộc thi "Kịch bản phim ngắn Việt Nam 2025" đã diễn ra trang trọng tại Trung tâm Chiếu phim Quốc gia, vinh danh những tài năng trẻ trong lĩnh vực sáng tác kịch bản phim.',
        images: [
            {
                src: 'assets/images/new/diadao4.jpg',
        ...
        paragraphs: [
            'Cuộc thi "Kịch bản phim ngắn Việt Nam 2025" là sáng kiến của Trung tâm Chiếu phim Quốc gia nhằm khuyến khích sáng tạo trong lĩnh vực viết kịch bản phim và phát hiện những tài năng mới. Cuộc thi đã thu hút hơn 200 bài dự thi từ các tác giả trẻ trên cả nước.',
            ...
            'Đặc biệt, 5 kịch bản xuất sắc nhất sẽ được Trung tâm Chiếu phim Quốc gia hỗ trợ kinh phí sản xuất thành phim ngắn và công chiếu tại Trung tâm vào cuối năm nay.',
        ],
        relatedNews: [
            { id: 9, title: 'Liên hoan phim ngắn cuối tuần tại Trung tâm Chiếu phim Quốc gia' },
            { id: 11, title: 'Workshop "Nghệ thuật dựng phim" tại Trung tâm Chiếu phim Quốc gia' },
            { id: 3, title: 'THẾ QUYỀN LỰC CHO GEN Z ĐẨY RỒI!!!' }
        ]
    },

    '13': {
        title: 'Chương trình chiếu phim đặc biệt cho trẻ em khuyết tật tại Trung tâm Chiếu phim Quốc gia',
        date: '15/03/2025',
        intro: 'Trung tâm Chiếu phim Quốc gia phối hợp với các tổ chức từ thiện tổ chức chương trình chiếu phim đặc biệt dành cho trẻ em khuyết tật, nhằm mang đến trải nghiệm điện ảnh độc đáo và ý nghĩa cho các em nhỏ có hoàn cảnh đặc biệt.',
        images: [
            {
                src: 'assets/images/new/thegenz1.jpg',
                caption: 'Các em nhỏ hào hứng tham gia chương trình tại Trung tâm Chiếu phim Quốc gia'
            }
        ],
        paragraphs: [
            ...
            'Đại diện Trung tâm Chiếu phim Quốc gia cho biết: "Chúng tôi mong muốn nghệ thuật điện ảnh có thể đến với mọi đối tượng khán giả, không phân biệt hoàn cảnh hay điều kiện sống. Những nụ cười của các em hôm nay là động lực để chúng tôi tiếp tục duy trì và mở rộng chương trình này trong những năm tiếp theo."',
        ],
        relatedNews: [
            { id: 5, title: 'SUẤT CHIẾU ĐẶC BIỆT SÁNG THỨ 7 TẠI NCC' },
            { id: 3, title: 'THẾ QUYỀN LỰC CHO GEN Z ĐẨY RỒI!!!' },
    ...
    '14': {
        title: 'Trung tâm Chiếu phim Quốc gia nâng cấp hệ thống âm thanh Dolby Atmos',
        date: '10/03/2025',
        intro: 'Trung tâm Chiếu phim Quốc gia chính thức khánh thành hệ thống âm thanh Dolby Atmos hiện đại, đánh dấu bước tiến quan trọng trong việc nâng cao chất lượng trải nghiệm điện ảnh cho khán giả Việt Nam.',
        images: [
            {
                src: 'assets/images/new/dot2.jpg',
                caption: 'Lễ khánh thành hệ thống âm thanh mới tại Trung tâm Chiếu phim Quốc gia'
            }
        ],
        paragraphs: [
            ...
            'Đại diện Trung tâm Chiếu phim Quốc gia cho biết, việc nâng cấp hệ thống âm thanh nằm trong kế hoạch hiện đại hóa cơ sở vật chất kỹ thuật, nhằm đáp ứng nhu cầu ngày càng cao của khán giả về chất lượng trải nghiệm điện ảnh.',
        ],
        relatedNews: [
            { id: 15, title: 'Trung tâm Chiếu phim Quốc gia kỷ niệm 5 năm thành lập rạp chiếu phim 4D đầu tiên tại Việt Nam' },
            { id: 8, title: 'Sự kiện ra mắt phim Địa Đạo - Một Trời Trong Bóng Tối tại Trung tâm Chiếu phim Quốc gia' },
            { id: 5, title: 'SUẤT CHIẾU ĐẶC BIỆT SÁNG THỨ 7 TẠI NCC' }
        ]
    },
    ...
    '15': {
        title: 'Trung tâm Chiếu phim Quốc gia kỷ niệm 5 năm thành lập rạp chiếu phim 4D đầu tiên tại Việt Nam',
        date: '05/03/2025',
        intro: 'Trung tâm Chiếu phim Quốc gia tổ chức lễ kỷ niệm 5 năm thành lập rạp chiếu phim 4D đầu tiên tại Việt Nam với nhiều hoạt động đặc sắc và ưu đãi hấp dẫn cho khán giả.',
        images: [
            {
                src: 'assets/images/new/nhoctrum3.jpg',
        ...
        paragraphs: [
            'Rạp chiếu phim 4D tại Trung tâm Chiếu phim Quốc gia chính thức đi vào hoạt động từ tháng 3/2020, mở ra một kỷ nguyên mới cho trải nghiệm điện ảnh tại Việt Nam. Trong 5 năm qua, rạp đã phục vụ hơn 1 triệu lượt khán giả, chiếu hơn 200 bộ phim định dạng 4D.',
            'Nhân dịp kỷ niệm 5 năm thành lập, Trung tâm Chiếu phim Quốc gia tổ chức tuần lễ phim 4D với giá vé ưu đãi đặc biệt chỉ bằng 50% giá vé thông thường. Ngoài ra, 100 khán giả đầu tiên mỗi ngày còn được tặng bộ sưu tập kính 4D phiên bản giới hạn.',
        ...
        relatedNews: [
            { id: 14, title: 'Trung tâm Chiếu phim Quốc gia nâng cấp hệ thống âm thanh Dolby Atmos' },
            { id: 5, title: 'SUẤT CHIẾU ĐẶC BIỆT SÁNG THỨ 7 TẠI NCC' },
            { id: 13, title: 'Chương trình chiếu phim đặc biệt cho trẻ em khuyết tật tại Trung tâm Chiếu phim Quốc gia' }
        ]
    },

    '16': {
        title: 'Trung tâm Chiếu phim Quốc gia tổ chức "Tuần lễ điện ảnh Nhật Bản 2025"',
        date: '01/03/2025',
        intro: 'Trung tâm Chiếu phim Quốc gia phối hợp với Đại sứ quán Nhật Bản tại Việt Nam tổ chức "Tuần lễ điện ảnh Nhật Bản 2025", giới thiệu những tác phẩm điện ảnh xuất sắc của xứ sở hoa anh đào đến khán giả Việt Nam.',
        images: [
            {
                src: 'assets/images/new/diadao3.jpg',
        ...
        paragraphs: [
            'Tuần lễ điện ảnh Nhật Bản 2025 diễn ra từ ngày 1/3 đến 7/3/2025 tại Trung tâm Chiếu phim Quốc gia, với 14 bộ phim đặc sắc thuộc nhiều thể loại khác nhau, từ phim nghệ thuật, phim thương mại đến phim hoạt hình anime nổi tiếng.',
        ...
        relatedNews: [
            { id: 10, title: 'Triển lãm "50 năm điện ảnh Việt Nam" tại Trung tâm Chiếu phim Quốc gia' },
            { id: 9, title: 'Liên hoan phim ngắn cuối tuần tại Trung tâm Chiếu phim Quốc gia' },
            { id: 5, title: 'SUẤT CHIẾU ĐẶC BIỆT SÁNG THỨ 7 TẠI NCC' }
        ]
    }
